...
// /replise/{bno}/{page}		page list : GET 방식
...
public class ReplyController {
	...
	public ResponseEntity<String> remove(@PathVariable("rno") int rno, @PathVariable("bno") int bno, @PathVariable("page") int page) throws SQLException{
		ResponseEntity<String> entity = null;

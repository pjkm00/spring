...
window.onload = function(){
	...
	$('#addFileBtn').on('click', function(){
		...
		div.append(input).append("<button style='border:0; outline:0;' class='badge bg-red' id='inputFileRemoveBtn' type='button'>X</button>");
	...
	//파일 삭제 버튼
	$('.fileInput').on('click', '#inputFileRemoveBtn', function(){
